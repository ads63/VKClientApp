    ...
    required init(from decoder: Decoder) throws {
        ...
        let likesContainer = try container
            .nestedContainer(keyedBy: CodingKeys.LikesKeys.self,
                             forKey: .likes)
        self.flags.likesCount = try likesContainer.decode(Int.self,
                                                          forKey: .count)
        self.flags.isLiked = try likesContainer.decode(Int.self,
                                                       forKey: .user_likes)
        let repostsContainer = try container
            .nestedContainer(keyedBy: CodingKeys.RepostsKeys.self,
                             forKey: .reposts)
        self.flags.repostsCount = try repostsContainer.decode(Int.self,
                                                              forKey: .count)
        self.flags.isReposted = try repostsContainer.decode(Int.self,
                                                            forKey: .user_reposted)
        let commentsContainer = try container
            .nestedContainer(keyedBy: CodingKeys.CommentsKeys.self,
                             forKey: .comments)
        self.flags.commentsCount = try commentsContainer.decode(Int.self,
                                                                forKey: .count)
        self.flags.canRepost = try container.decode(Int.self,
                                                    forKey: .can_repost)
        self.flags.canComment = try container.decode(Int.self,
                                                     forKey: .can_comment)
